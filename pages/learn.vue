<template>
  <div class="space-y-4">
    <h1 class="text-2xl font-black text-slate-800">Aprender</h1>
    <p class="text-slate-500 text-sm">Completa las lecciones en orden para desbloquear las siguientes.</p>
    ...
    <div class="card border-2 border-dashed border-slate-200 text-center py-6">
      ...
      <p class="font-bold text-slate-400">Nivel A2 — próximamente</p>
    </div>
  </div>
</template>
