import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, ref, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'vue';
...
const unhead_EL9qVgX9Ji_ld0AGfK8DVvwfrsjMKw46NEltsJBzR3Q = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dk1K471j.mjs')
  },
  {
    name: "learn",
    path: "/learn",
    component: () => import('./learn-ByOAb7l_.mjs')
  },
  {
    name: "aiworld",
    path: "/aiworld",
    component: () => import('./aiworld-BQt560Ut.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-BRibi69O.mjs')
  },
  {
    name: "onboarding",
    path: "/onboarding",
    meta: __nuxt_page_meta || {},
    component: () => import('./onboarding-lpjG6lGO.mjs')
  },
  {
    name: "lesson-id",
    path: "/lesson/:id()",
    component: () => import('./_id_-0hOrpTq7.mjs')
  },
  {
    name: "achievements",
    path: "/achievements",
    component: () => import('./achievements-DRHiP11d.mjs')
  }
];
...
const LEVEL_THRESHOLDS = [0, 100, 250, 450, 700, 1e3, 1400, 1900, 2500, 3200, 4e3];
...
const useUserStore = defineStore(
  ...
  () => {
    const name = ref("");
    const avatar = ref(createDefaultAvatar());
    const xp = ref(0);
    const streak = ref(0);
...
const onboarding_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  return;
});
...
const revive_payload_server_lPDALdfLdSoYeZDVyx_lr_7Zn2aEEw_bO83MJCOzXMo = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_EL9qVgX9Ji_ld0AGfK8DVvwfrsjMKw46NEltsJBzR3Q,
  plugin$1,
  revive_payload_server_lPDALdfLdSoYeZDVyx_lr_7Zn2aEEw_bO83MJCOzXMo,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-BhaDw4iz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Q0iU7FQH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CEz6-QR0.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1._7daf8d98b5d830b0a64ebfdb2e56c31f/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1._7daf8d98b5d830b0a64ebfdb2e56c31f/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { CHEEK_STYLE_OPTIONS as C, EYE_COLOR_OPTIONS as E, FACE_SHAPE_OPTIONS as F, HAIR_OPTIONS as H, OUTFIT_OPTIONS as O, SHOES_OPTIONS as S, _export_sfc as _, useRouter as a, EYE_STYLE_OPTIONS as b, CHEEK_COLOR_OPTIONS as c, HAIR_COLOR_OPTIONS as d, entry_default as default, createDefaultAvatar as e, useRoute as f, encodeRoutePath as g, useNuxtApp as h, useRuntimeConfig as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useUserStore as u };
